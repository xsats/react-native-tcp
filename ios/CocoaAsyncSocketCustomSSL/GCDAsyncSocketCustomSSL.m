...
#ifndef GCDCSSLAsyncSocketLoggingEnabled
#define GCDCSSLAsyncSocketLoggingEnabled 0
#endif

#if GCDCSSLAsyncSocketLoggingEnabled
...
#define LogAsync   YES
#define LogContext GCDCSSLAsyncSocketLoggingContext
...
#ifndef GCDCSSLAsyncSocketLogLevel
#define GCDCSSLAsyncSocketLogLevel LOG_LEVEL_VERBOSE
#endif

// Log levels : off, error, warn, info, verbose
static const int logLevel = GCDCSSLAsyncSocketLogLevel;
...
NSString *const GCDCSSLAsyncSocketException = @"GCDCSSLAsyncSocketException";
NSString *const GCDCSSLAsyncSocketErrorDomain = @"GCDCSSLAsyncSocketErrorDomain";

NSString *const GCDCSSLAsyncSocketQueueName = @"GCDCSSLAsyncSocket";
NSString *const GCDCSSLAsyncSocketThreadName = @"GCDCSSLAsyncSocket-CFStream";

NSString *const GCDCSSLAsyncSocketManuallyEvaluateTrust = @"GCDCSSLAsyncSocketManuallyEvaluateTrust";
#if TARGET_OS_IPHONE
NSString *const GCDCSSLAsyncSocketUseCFStreamForTLS = @"GCDCSSLAsyncSocketUseCFStreamForTLS";
#endif
NSString *const GCDCSSLAsyncSocketSSLPeerID = @"GCDCSSLAsyncSocketSSLPeerID";
NSString *const GCDCSSLAsyncSocketSSLProtocolVersionMin = @"GCDCSSLAsyncSocketSSLProtocolVersionMin";
NSString *const GCDCSSLAsyncSocketSSLProtocolVersionMax = @"GCDCSSLAsyncSocketSSLProtocolVersionMax";
NSString *const GCDCSSLAsyncSocketSSLSessionOptionFalseStart = @"GCDCSSLAsyncSocketSSLSessionOptionFalseStart";
NSString *const GCDCSSLAsyncSocketSSLSessionOptionSendOneByteRecord = @"GCDCSSLAsyncSocketSSLSessionOptionSendOneByteRecord";
NSString *const GCDCSSLAsyncSocketSSLCipherSuites = @"GCDCSSLAsyncSocketSSLCipherSuites";
#if !TARGET_OS_IPHONE
NSString *const GCDCSSLAsyncSocketSSLDiffieHellmanParameters = @"GCDCSSLAsyncSocketSSLDiffieHellmanParameters";
#endif

enum GCDCSSLAsyncSocketFlags
{
...
@interface GCDCSSLAsyncSocketPreBuffer : NSObject
{
	uint8_t *preBuffer;
...
@implementation GCDCSSLAsyncSocketPreBuffer
...
/**
 * The GCDCSSLAsyncReadPacket encompasses the instructions for any given read.
 * The content of a read packet allows the code to determine if we're:
 *  - reading to a certain length
 *  - reading to a certain separator
 *  - or simply reading the first chunk of available data
**/
@interface GCDCSSLAsyncReadPacket : NSObject
{
  @public
...
- (NSUInteger)readLengthForTermWithPreBuffer:(GCDCSSLAsyncSocketPreBuffer *)preBuffer found:(BOOL *)foundPtr;

- (NSInteger)searchForTermAfterPreBuffering:(ssize_t)numBytes;

@end

@implementation GCDCSSLAsyncReadPacket
...
/**
 * The GCDCSSLAsyncWritePacket encompasses the instructions for any given write.
**/
@interface GCDCSSLAsyncWritePacket : NSObject
{
  @public
	NSData *buffer;
	NSUInteger bytesDone;
...
@implementation GCDCSSLAsyncWritePacket
...
/**
 * The GCDCSSLAsyncSpecialPacket encompasses special instructions for interruptions in the read/write queues.
 * This class my be altered to support more than just TLS in the future.
**/
@interface GCDCSSLAsyncSpecialPacket : NSObject
{
  @public
...
@implementation GCDCSSLAsyncSpecialPacket
...
@implementation GCDCSSLAsyncSocket
{
	uint32_t flags;
	uint16_t config;
	
	__weak id<GCDCSSLAsyncSocketDelegate> delegate;
	...
	GCDCSSLAsyncReadPacket *currentRead;
	GCDCSSLAsyncWritePacket *currentWrite;
	
	unsigned long socketFDBytesAvailable;
	
	GCDCSSLAsyncSocketPreBuffer *preBuffer;
	...
	GCDCSSLAsyncSocketPreBuffer *sslPreBuffer;
...
- (id)initWithDelegate:(id)aDelegate delegateQueue:(dispatch_queue_t)dq socketQueue:(dispatch_queue_t)sq
{
	if((self = [super init]))
	{
		...
		{
			socketQueue = dispatch_queue_create([GCDCSSLAsyncSocketQueueName UTF8String], NULL);
		}
		...
		preBuffer = [[GCDCSSLAsyncSocketPreBuffer alloc] initWithCapacity:(1024 * 4)];
...
- (void)getDelegate:(id<GCDCSSLAsyncSocketDelegate> *)delegatePtr delegateQueue:(dispatch_queue_t *)delegateQueuePtr
{
	if (dispatch_get_specific(IsOnSocketQueueOrTargetQueueKey))
	{
...
- (BOOL)acceptOnInterface:(NSString *)inInterface port:(uint16_t)port error:(NSError **)errPtr
{
	...
	dispatch_block_t block = ^{ @autoreleasepool {
		...
		if (enableIPv4)
		{
			...
			__weak GCDCSSLAsyncSocket *weakSelf = self;
			
			dispatch_source_set_event_handler(accept4Source, ^{ @autoreleasepool {
			#pragma clang diagnostic push
			#pragma clang diagnostic warning "-Wimplicit-retain-self"
				
				__strong GCDCSSLAsyncSocket *strongSelf = weakSelf;
...
- (BOOL)doAccept:(int)parentSocketFD
{
	...
	if (delegateQueue)
	{
		...
		dispatch_async(delegateQueue, ^{ @autoreleasepool {
			...
			// Create GCDCSSLAsyncSocket instance for accepted socket
			
			GCDCSSLAsyncSocket *acceptedSocket = [[[self class] alloc] initWithDelegate:theDelegate
...
- (NSError *)badConfigError:(NSString *)errMsg
{
	...
	return [NSError errorWithDomain:GCDCSSLAsyncSocketErrorDomain code:GCDCSSLAsyncSocketBadConfigError userInfo:userInfo];
}
...
- (NSError *)badParamError:(NSString *)errMsg
{
	...
	return [NSError errorWithDomain:GCDCSSLAsyncSocketErrorDomain code:GCDCSSLAsyncSocketBadParamError userInfo:userInfo];
}
...
{
	NSString *errMsg = NSLocalizedStringWithDefaultValue(@"GCDCSSLAsyncSocketConnectTimeoutError",
	                                                     @"GCDCSSLAsyncSocket", [NSBundle mainBundle],
	                                                     @"Attempt to connect to host timed out", nil);
	
	NSDictionary *userInfo = [NSDictionary dictionaryWithObject:errMsg forKey:NSLocalizedDescriptionKey];
	
	return [NSError errorWithDomain:GCDCSSLAsyncSocketErrorDomain code:GCDCSSLAsyncSocketConnectTimeoutError userInfo:userInfo];
}
...
{
	NSString *errMsg = NSLocalizedStringWithDefaultValue(@"GCDCSSLAsyncSocketReadMaxedOutError",
														 @"GCDCSSLAsyncSocket", [NSBundle mainBundle],
														 @"Read operation reached set maximum length", nil);
	
	NSDictionary *info = [NSDictionary dictionaryWithObject:errMsg forKey:NSLocalizedDescriptionKey];
	
	return [NSError errorWithDomain:GCDCSSLAsyncSocketErrorDomain code:GCDCSSLAsyncSocketReadMaxedOutError userInfo:info];
}
...
{
	NSString *errMsg = NSLocalizedStringWithDefaultValue(@"GCDCSSLAsyncSocketReadTimeoutError",
	                                                     @"GCDCSSLAsyncSocket", [NSBundle mainBundle],
	                                                     @"Read operation timed out", nil);
	
	NSDictionary *userInfo = [NSDictionary dictionaryWithObject:errMsg forKey:NSLocalizedDescriptionKey];
	
	return [NSError errorWithDomain:GCDCSSLAsyncSocketErrorDomain code:GCDCSSLAsyncSocketReadTimeoutError userInfo:userInfo];
}
...
{
	NSString *errMsg = NSLocalizedStringWithDefaultValue(@"GCDCSSLAsyncSocketWriteTimeoutError",
	                                                     @"GCDCSSLAsyncSocket", [NSBundle mainBundle],
	                                                     @"Write operation timed out", nil);
	
	NSDictionary *userInfo = [NSDictionary dictionaryWithObject:errMsg forKey:NSLocalizedDescriptionKey];
	
	return [NSError errorWithDomain:GCDCSSLAsyncSocketErrorDomain code:GCDCSSLAsyncSocketWriteTimeoutError userInfo:userInfo];
}

- (NSError *)connectionClosedError
{
	NSString *errMsg = NSLocalizedStringWithDefaultValue(@"GCDCSSLAsyncSocketClosedError",
	                                                     @"GCDCSSLAsyncSocket", [NSBundle mainBundle],
	                                                     @"Socket closed by remote peer", nil);
	
	NSDictionary *userInfo = [NSDictionary dictionaryWithObject:errMsg forKey:NSLocalizedDescriptionKey];
	
	return [NSError errorWithDomain:GCDCSSLAsyncSocketErrorDomain code:GCDCSSLAsyncSocketClosedError userInfo:userInfo];
}
...
- (NSError *)otherError:(NSString *)errMsg
{
	...
	return [NSError errorWithDomain:GCDCSSLAsyncSocketErrorDomain code:GCDCSSLAsyncSocketOtherError userInfo:userInfo];
}
...
- (BOOL)usingCFStreamForTLS
{
	...
	{
		// The startTLS method was given the GCDCSSLAsyncSocketUseCFStreamForTLS flag.
                        ...
                        tag:(long)tag
{
	...
	GCDCSSLAsyncReadPacket *packet = [[GCDCSSLAsyncReadPacket alloc] initWithData:buffer
	                                                          startOffset:offset
	                                                            maxLength:length
	                                                              timeout:timeout
	                                                           readLength:0
...
- (float)progressOfReadReturningTag:(long *)tagPtr bytesDone:(NSUInteger *)donePtr total:(NSUInteger *)totalPtr
{
	...
	dispatch_block_t block = ^{
		...
		if (!currentRead || ![currentRead isKindOfClass:[GCDCSSLAsyncReadPacket class]])
		{
...
- (void)maybeDequeueRead
{
	...
	if ((currentRead == nil) && (flags & kConnected))
	{
		if ([readQueue count] > 0)
		{
			...
			if ([currentRead isKindOfClass:[GCDCSSLAsyncSpecialPacket class]])
			{
				LogVerbose(@"Dequeued GCDCSSLAsyncSpecialPacket");
			...
			{
				LogVerbose(@"Dequeued GCDCSSLAsyncReadPacket");
...
- (void)doReadData
{
	...
	if ([self usingCFStreamForTLS])
	{
		...
		// Requested CFStream, rather than SecureTransport, for TLS (via GCDCSSLAsyncSocketUseCFStreamForTLS)
...
- (void)completeCurrentRead
{
	...
	{
		GCDCSSLAsyncReadPacket *theRead = currentRead; // Ensure currentRead retained since result may not own buffer
...
- (void)doReadTimeout
{
	...
	{
		GCDCSSLAsyncReadPacket *theRead = currentRead;
...
- (void)writeData:(NSData *)data withTimeout:(NSTimeInterval)timeout tag:(long)tag
{
	...
	GCDCSSLAsyncWritePacket *packet = [[GCDCSSLAsyncWritePacket alloc] initWithData:data timeout:timeout tag:tag];
...
- (float)progressOfWriteReturningTag:(long *)tagPtr bytesDone:(NSUInteger *)donePtr total:(NSUInteger *)totalPtr
{
	...
	dispatch_block_t block = ^{
		...
		if (!currentWrite || ![currentWrite isKindOfClass:[GCDCSSLAsyncWritePacket class]])
		{
...
- (void)maybeDequeueWrite
{
	...
	if ((currentWrite == nil) && (flags & kConnected))
	{
		if ([writeQueue count] > 0)
		{
			...
			if ([currentWrite isKindOfClass:[GCDCSSLAsyncSpecialPacket class]])
			{
				LogVerbose(@"Dequeued GCDCSSLAsyncSpecialPacket");
			...
			{
				LogVerbose(@"Dequeued GCDCSSLAsyncWritePacket");
...
- (void)doWriteData
{
	...
	// Note: This method is not called if currentWrite is a GCDCSSLAsyncSpecialPacket (startTLS packet)
...
- (void)doWriteTimeout
{
	...
	{
		GCDCSSLAsyncWritePacket *theWrite = currentWrite;
...
- (void)doStartTLS:(NSDictionary *)tlsSettings withCancelCurrentRead:(BOOL)cancelCurrentRead
{
	...
	GCDCSSLAsyncSpecialPacket *packet = [[GCDCSSLAsyncSpecialPacket alloc] initWithTLSSettings:tlsSettings];
...
- (void)maybeStartTLS
{
	...
	if ((flags & kStartingReadTLS) && (flags & kStartingWriteTLS))
	{
		...
		#if TARGET_OS_IPHONE
		{
			GCDCSSLAsyncSpecialPacket *tlsPacket = (GCDCSSLAsyncSpecialPacket *)currentRead;
            NSDictionary *tlsSettings = @{};
            if (tlsPacket) {
                tlsSettings = tlsPacket->tlsSettings;
            }
			NSNumber *value = [tlsSettings objectForKey:GCDCSSLAsyncSocketUseCFStreamForTLS];
...
{
	GCDCSSLAsyncSocket *asyncSocket = (__bridge GCDCSSLAsyncSocket *)connection;
...
- (void)ssl_startTLS
{
	...
	BOOL shouldManuallyEvaluateTrust = [[tlsSettings objectForKey:GCDCSSLAsyncSocketManuallyEvaluateTrust] boolValue];
	...
	//  3. GCDCSSLAsyncSocketSSLPeerID
	//  4. GCDCSSLAsyncSocketSSLProtocolVersionMin
	//  5. GCDCSSLAsyncSocketSSLProtocolVersionMax
	//  6. GCDCSSLAsyncSocketSSLSessionOptionFalseStart
	//  7. GCDCSSLAsyncSocketSSLSessionOptionSendOneByteRecord
	//  8. GCDCSSLAsyncSocketSSLCipherSuites
	//  9. GCDCSSLAsyncSocketSSLDiffieHellmanParameters (Mac)
	//
	...
	value = [tlsSettings objectForKey:GCDCSSLAsyncSocketSSLPeerID];
	...
	{
		NSAssert(NO, @"Invalid value for GCDCSSLAsyncSocketSSLPeerID. Value must be of type NSData."
		             @" (You can convert strings to data using a method like"
		             @" [string dataUsingEncoding:NSUTF8StringEncoding])");
		
		[self closeWithError:[self otherError:@"Invalid value for GCDCSSLAsyncSocketSSLPeerID."]];
		return;
	}
	
	// 4. GCDCSSLAsyncSocketSSLProtocolVersionMin
	
	value = [tlsSettings objectForKey:GCDCSSLAsyncSocketSSLProtocolVersionMin];
	...
	{
		NSAssert(NO, @"Invalid value for GCDCSSLAsyncSocketSSLProtocolVersionMin. Value must be of type NSNumber.");
		
		[self closeWithError:[self otherError:@"Invalid value for GCDCSSLAsyncSocketSSLProtocolVersionMin."]];
		return;
	}
	
	// 5. GCDCSSLAsyncSocketSSLProtocolVersionMax
	
	value = [tlsSettings objectForKey:GCDCSSLAsyncSocketSSLProtocolVersionMax];
	if ([value isKindOfClass:[NSNumber class]])
	{
	...
	{
		NSAssert(NO, @"Invalid value for GCDCSSLAsyncSocketSSLProtocolVersionMax. Value must be of type NSNumber.");
		
		[self closeWithError:[self otherError:@"Invalid value for GCDCSSLAsyncSocketSSLProtocolVersionMax."]];
		return;
	}
	
	// 6. GCDCSSLAsyncSocketSSLSessionOptionFalseStart
	
	value = [tlsSettings objectForKey:GCDCSSLAsyncSocketSSLSessionOptionFalseStart];
	if ([value isKindOfClass:[NSNumber class]])
	{
	...
	{
		NSAssert(NO, @"Invalid value for GCDCSSLAsyncSocketSSLSessionOptionFalseStart. Value must be of type NSNumber.");
		
		[self closeWithError:[self otherError:@"Invalid value for GCDCSSLAsyncSocketSSLSessionOptionFalseStart."]];
		return;
	}
	
	// 7. GCDCSSLAsyncSocketSSLSessionOptionSendOneByteRecord
	
	value = [tlsSettings objectForKey:GCDCSSLAsyncSocketSSLSessionOptionSendOneByteRecord];
	if ([value isKindOfClass:[NSNumber class]])
	{
	...
	{
		NSAssert(NO, @"Invalid value for GCDCSSLAsyncSocketSSLSessionOptionSendOneByteRecord."
		             @" Value must be of type NSNumber.");
		
		[self closeWithError:[self otherError:@"Invalid value for GCDCSSLAsyncSocketSSLSessionOptionSendOneByteRecord."]];
		return;
	}
	
	// 8. GCDCSSLAsyncSocketSSLCipherSuites
	
	value = [tlsSettings objectForKey:GCDCSSLAsyncSocketSSLCipherSuites];
	if ([value isKindOfClass:[NSArray class]])
	{
	...
	{
		NSAssert(NO, @"Invalid value for GCDCSSLAsyncSocketSSLCipherSuites. Value must be of type NSArray.");
		
		[self closeWithError:[self otherError:@"Invalid value for GCDCSSLAsyncSocketSSLCipherSuites."]];
		return;
	}
	
	// 9. GCDCSSLAsyncSocketSSLDiffieHellmanParameters
	
	#if !TARGET_OS_IPHONE
	value = [tlsSettings objectForKey:GCDCSSLAsyncSocketSSLDiffieHellmanParameters];
	if ([value isKindOfClass:[NSData class]])
	{
	...
	{
		NSAssert(NO, @"Invalid value for GCDCSSLAsyncSocketSSLDiffieHellmanParameters. Value must be of type NSData.");
		
		[self closeWithError:[self otherError:@"Invalid value for GCDCSSLAsyncSocketSSLDiffieHellmanParameters."]];
		return;
	}
	#endif
	...
	if (value)
	{
		NSAssert(NO, @"Security option unavailable - kCFStreamSSLLevel"
		             @" - You must use GCDCSSLAsyncSocketSSLProtocolVersionMin & GCDCSSLAsyncSocketSSLProtocolVersionMax");
	...
	sslPreBuffer = [[GCDCSSLAsyncSocketPreBuffer alloc] initWithCapacity:(1024 * 4)];
...
- (void)ssl_continueSSLHandshake
{
	...
	else if (status == errSSLPeerAuthCompleted)
	{
		...
		else
		{
			...
			NSString *msg = @"GCDCSSLAsyncSocketManuallyEvaluateTrust specified in tlsSettings,"
...
- (void)cf_startTLS
{
	...
	NSAssert([currentRead isKindOfClass:[GCDCSSLAsyncSpecialPacket class]], @"Invalid read packet for startTLS");
	NSAssert([currentWrite isKindOfClass:[GCDCSSLAsyncSpecialPacket class]], @"Invalid write packet for startTLS");
...
+ (void)startCFStreamThreadIfNeeded
{
	...
	dispatch_once(&predicate, ^{
		...
		cfstreamThreadSetupQueue = dispatch_queue_create("GCDCSSLAsyncSocket-CFStreamThreadSetup", DISPATCH_QUEUE_SERIAL);
	});
...
{
	[[NSThread currentThread] setName:GCDCSSLAsyncSocketThreadName];
...
+ (void)scheduleCFStreams:(GCDCSSLAsyncSocket *)asyncSocket
{
	LogTrace();
...
+ (void)unscheduleCFStreams:(GCDCSSLAsyncSocket *)asyncSocket
{
	LogTrace();
	NSAssert([NSThread currentThread] == cfstreamThread, @"Invoked on wrong thread");
...
{
	GCDCSSLAsyncSocket *asyncSocket = (__bridge GCDCSSLAsyncSocket *)pInfo;

...
@class GCDCSSLAsyncReadPacket;
@class GCDCSSLAsyncWritePacket;
@class GCDCSSLAsyncSocketPreBuffer;
@protocol GCDCSSLAsyncSocketDelegate;

NS_ASSUME_NONNULL_BEGIN

extern NSString *const GCDCSSLAsyncSocketException;
extern NSString *const GCDCSSLAsyncSocketErrorDomain;

extern NSString *const GCDCSSLAsyncSocketQueueName;
extern NSString *const GCDCSSLAsyncSocketThreadName;

extern NSString *const GCDCSSLAsyncSocketManuallyEvaluateTrust;
#if TARGET_OS_IPHONE
extern NSString *const GCDCSSLAsyncSocketUseCFStreamForTLS;
#endif
#define GCDCSSLAsyncSocketSSLPeerName     (NSString *)kCFStreamSSLPeerName
#define GCDCSSLAsyncSocketSSLCertificates (NSString *)kCFStreamSSLCertificates
#define GCDCSSLAsyncSocketSSLIsServer     (NSString *)kCFStreamSSLIsServer
extern NSString *const GCDCSSLAsyncSocketSSLPeerID;
extern NSString *const GCDCSSLAsyncSocketSSLProtocolVersionMin;
extern NSString *const GCDCSSLAsyncSocketSSLProtocolVersionMax;
extern NSString *const GCDCSSLAsyncSocketSSLSessionOptionFalseStart;
extern NSString *const GCDCSSLAsyncSocketSSLSessionOptionSendOneByteRecord;
extern NSString *const GCDCSSLAsyncSocketSSLCipherSuites;
#if !TARGET_OS_IPHONE
extern NSString *const GCDCSSLAsyncSocketSSLDiffieHellmanParameters;
#endif

#define GCDCSSLAsyncSocketLoggingContext 65535


typedef NS_ENUM(NSInteger, GCDCSSLAsyncSocketError) {
	GCDCSSLAsyncSocketNoError = 0,           // Never used
	GCDCSSLAsyncSocketBadConfigError,        // Invalid configuration
	GCDCSSLAsyncSocketBadParamError,         // Invalid parameter was passed
	GCDCSSLAsyncSocketConnectTimeoutError,   // A connect operation timed out
	GCDCSSLAsyncSocketReadTimeoutError,      // A read operation timed out
	GCDCSSLAsyncSocketWriteTimeoutError,     // A write operation timed out
	GCDCSSLAsyncSocketReadMaxedOutError,     // Reached set maxLength without completing
	GCDCSSLAsyncSocketClosedError,           // The remote peer closed the connection
	GCDCSSLAsyncSocketOtherError,            // Description provided in userInfo
};
...
@interface GCDCSSLAsyncSocket : NSObject

/**
 * GCDCSSLAsyncSocket uses the standard delegate paradigm,
 ...
 * If you pass NULL, GCDCSSLAsyncSocket will automatically create it's own socket queue.
...
- (instancetype)initWithDelegate:(nullable id<GCDCSSLAsyncSocketDelegate>)aDelegate delegateQueue:(nullable dispatch_queue_t)dq;
- (instancetype)initWithDelegate:(nullable id<GCDCSSLAsyncSocketDelegate>)aDelegate delegateQueue:(nullable dispatch_queue_t)dq socketQueue:(nullable dispatch_queue_t)sq;

#pragma mark Configuration

@property (atomic, weak, readwrite, nullable) id<GCDCSSLAsyncSocketDelegate> delegate;
...
- (void)getDelegate:(id<GCDCSSLAsyncSocketDelegate> __nullable * __nullable)delegatePtr delegateQueue:(dispatch_queue_t __nullable * __nullable)delegateQueuePtr;
- (void)setDelegate:(nullable id<GCDCSSLAsyncSocketDelegate>)delegate delegateQueue:(nullable dispatch_queue_t)delegateQueue;
...
**/
- (void)synchronouslySetDelegate:(nullable id<GCDCSSLAsyncSocketDelegate>)delegate;
- (void)synchronouslySetDelegateQueue:(nullable dispatch_queue_t)delegateQueue;
- (void)synchronouslySetDelegate:(nullable id<GCDCSSLAsyncSocketDelegate>)delegate delegateQueue:(nullable dispatch_queue_t)delegateQueue;

/**
 * By default, both IPv4 and IPv6 are enabled.
 * 
 * For accepting incoming connections, this means GCDCSSLAsyncSocket automatically supports both protocols,
 * and can simulataneously accept incoming connections on either protocol.
 * 
 * For outgoing connections, this means GCDCSSLAsyncSocket can connect to remote hosts running either protocol.
 * If a DNS lookup returns only IPv4 results, GCDCSSLAsyncSocket will automatically use IPv4.
 * If a DNS lookup returns only IPv6 results, GCDCSSLAsyncSocket will automatically use IPv6.
 ...
 * When a connection is accepted, a new instance of GCDCSSLAsyncSocket will be spawned to handle it,
 ...
 * 
 * Please note the recommended way of releasing a GCDCSSLAsyncSocket instance (e.g. in a dealloc method)
 ...
 * it is treated similarly to a timeout - the socket is closed with a GCDCSSLAsyncSocketReadMaxedOutError.
 ...
 * This is due to the fact that GCDCSSLAsyncSocket does NOT copy the data. It simply retains it.
 ...
 * 
 * - GCDCSSLAsyncSocketManuallyEvaluateTrust
 ...
 *     So GCDCSSLAsyncSocket will invoke the delegate method socket:shouldTrustPeer: passing the SecTrustRef.
 *
 ...
 *
 * - GCDCSSLAsyncSocketUseCFStreamForTLS (iOS only)
 *     The value must be of type NSNumber, encapsulating a BOOL value.
 *     By default GCDCSSLAsyncSocket will use the SecureTransport layer to perform encryption.
 ...
 *     
 *     However, if you absolutely must, you can instruct GCDCSSLAsyncSocket to use the old-fashioned encryption
 *     technique by going through the CFStream instead. So instead of using SecureTransport, GCDCSSLAsyncSocket
 ...
 *     
 *     Thus all the other keys in the given dictionary will be ignored by GCDCSSLAsyncSocket,
 ...
 *
 * - GCDCSSLAsyncSocketSSLProtocolVersionMin
 * - GCDCSSLAsyncSocketSSLProtocolVersionMax
 ...
 * 
 * - GCDCSSLAsyncSocketSSLSessionOptionFalseStart
 *     The value must be of type NSNumber, encapsulating a BOOL value.
 *     See Apple's documentation for kSSLSessionOptionFalseStart.
 * 
 * - GCDCSSLAsyncSocketSSLSessionOptionSendOneByteRecord
 *     The value must be of type NSNumber, encapsulating a BOOL value.
 *     See Apple's documentation for kSSLSessionOptionSendOneByteRecord.
 * 
 * - GCDCSSLAsyncSocketSSLCipherSuites
 ...
 *
 * - GCDCSSLAsyncSocketSSLDiffieHellmanParameters (Mac OS X only)
 *     The value must be of type NSData.
 ...
 *     You MUST use manual trust evaluation instead (see GCDCSSLAsyncSocketManuallyEvaluateTrust).
 ...
 *     You MUST use GCDCSSLAsyncSocketSSLProtocolVersionMin & GCDCSSLAsyncSocketSSLProtocolVersionMin instead.
...
/**
 * GCDCSSLAsyncSocket maintains thread safety by using an internal serial dispatch_queue.
 ...
 * - (dispatch_queue_t)newSocketQueueForConnectionFromAddress:(NSData *)address onSocket:(GCDCSSLAsyncSocket *)sock
 * {
...
@protocol GCDCSSLAsyncSocketDelegate <NSObject>
@optional
...
**/
- (nullable dispatch_queue_t)newSocketQueueForConnectionFromAddress:(NSData *)address onSocket:(GCDCSSLAsyncSocket *)sock;
 ...
 * The host parameter will be an IP address, not a DNS name.
 **/
- (void)socket:(GCDCSSLAsyncSocket *)sock didConnectToUrl:(NSURL *)url;
...
**/
- (void)socket:(GCDCSSLAsyncSocket *)sock didReadPartialDataOfLength:(NSUInteger)partialLength tag:(long)tag;

/**
 * Called when a socket has completed writing the requested data. Not called if there is an error.
**/
- (void)socket:(GCDCSSLAsyncSocket *)sock didWriteDataWithTag:(long)tag;

/**
 * Called when a socket has written some data, but has not yet completed the entire write.
 * It may be used to for things such as updating progress bars.
**/
- (void)socket:(GCDCSSLAsyncSocket *)sock didWritePartialDataOfLength:(NSUInteger)partialLength tag:(long)tag;
...
**/
- (NSTimeInterval)socket:(GCDCSSLAsyncSocket *)sock shouldTimeoutReadWithTag:(long)tag
...
**/
- (NSTimeInterval)socket:(GCDCSSLAsyncSocket *)sock shouldTimeoutWriteWithTag:(long)tag
                                                                  elapsed:(NSTimeInterval)elapsed
                                                                bytesDone:(NSUInteger)length;
 ...
 * 
 * Note: If the GCDCSSLAsyncSocket instance is deallocated while it is still connected,
...
**/
- (void)socketDidDisconnect:(GCDCSSLAsyncSocket *)sock withError:(nullable NSError *)err;
 ...
 * - GCDCSSLAsyncSocketManuallyEvaluateTrust == YES
 *
